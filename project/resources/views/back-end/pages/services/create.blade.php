...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <a class="btn btn-dark mt-3" href="{{ route('gestion_services.index') }}">Liste réalisation</a>
            <h3 class="m-2 text-center text-danger">NOUVEAU SERVICE</h3>

            <!-- Multi Columns Form -->
            <form class="row g-3 m-3" method="POST" action="{{route('gestion_services.store')}}" enctype="multipart/form-data">
                @csrf
