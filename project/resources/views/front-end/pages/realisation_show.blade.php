    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('realisation') }}">Nos realisations</a></li>
                <li>{{ $finds->nom_prog }}</li>
            </ol>
            <h2>{{ $finds->nom_prog }}</h2>
                        ...
                        <div class="sidebar-item recent-posts">
                            @forelse ($realisations as $real)
                                <div class="post-item clearfix">
                                    <img src="{{ asset('storage') . '/' . $real->img }}" alt="">
                                    <h4><a href="">{{$real->nom_prog}}</a></h4>
                                    <time datetime="2020-01-01">{{$real->date}}</time>
                                </div>
                            @empty
